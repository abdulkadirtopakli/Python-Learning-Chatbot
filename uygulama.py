...
def veritabani_yukle():
    with open('C:\\Users\\LENOVO\\OneDrive\\Desktop\\akıllı chatbot\\veritabani.json',  'r') as dosya:
        return json.load(dosya)
    
def veritabanina_yaz(veriler):
    with open('C:\\Users\\LENOVO\\OneDrive\\Desktop\\akıllı chatbot\\veritabani.json',  'w') as dosya:
...
def chat_bot():
    ...
    while True:
        ...
        if gelen_sonuc:
            ...
            print("Bot: Üzgünüm, bu soruyu nasıl cevaplayacağımı bilmiyorum. Öğretir misiniz?")
